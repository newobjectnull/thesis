...
\end{figure}
Sono stati inseriti i due bottoni \includegraphics[scale=0.4]{img/add} e 
\includegraphics[scale=0.4]{img/list} i quali sono rispettivamente per 
...
\lstinputlisting[firstline=535,lastline=571,breaklines=True,basicstyle=\ttfamily\scriptsize,title=Codice per la cancellazione di una nota di credito.]{code/controller/NotaCreditoController.java}
